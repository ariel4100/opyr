        ...
        <div class="row">
            ...
            <div class="col s12">
                ...
                <div class="col s12">
                    ...
                    <form method="POST"  enctype="multipart/form-data" action="{{action('PrivadaController@update',['id' => $descarga->id]) }}" class="col s12 m8 offset-m2 xl10 offset-xl1">
                        ...
                        <div class="row">
                            ...
                            <div class="file-field input-field s12">
                                ...
                                <div class="file-path-wrapper">
                                    ...
                                    <input class="file-path validate" type="text" value="{{ $descarga->file }}">
                            ...
                            <div class="input-field col m6 s12">
                                ...
                                <select id="icon_prefix" multiple class="select_all" name="cliente[]">
                                    @foreach($clientes as $c)
                                            <option value = "{{ $c->id }}" {{ in_array($c->id, $userSelected)?'selected':'' }} >{{ $c->name}}</option>
                                    @endforeach
                                </select>
                                <label for="icon_prefix">Seleccionar Cliente</label>
                            </div>
                            @php($data = json_decode($descarga->seccion))
                            ...
                            <div class="input-field col m6 s12">
                                ...
                                <select id="icon_prefix" multiple class="select_all" name="seccion[]">
                                    ...
                                    <option value="{{$item}}"  {{ in_array($item,$data) ? 'selected' : '' }}>{{ $k == 1 ? 'Informacion general' : ucwords($item) }}</option>
                                    @endforeach
                                </select>
                                {{--<option value="general" {{ isset($data[1]) == 'general' ?  'selected' : '' }} >Informacion general</option>--}}
