@include('adm.sliders.partials.header')
				...
				<form method="POST"  enctype="multipart/form-data" action="{{action('SliderController@update', ['id' => $slider->id, 'seccion' => $seccion])}}" class="col s12 m8 offset-m2 xl10 offset-xl1">
					{{ csrf_field() }}    
					{{ method_field('PUT')}}  
                    @if(request()->is('adm/control/slider/edit/'.$slider->id))
					<div class="row">
						<h5>Editar Slider</h5>					
					...
					<div class="row">
						...
						<div class="row">
							...
							<div class="col s6">							
								...
								<div class="input-field col s12">
									<textarea id="descripcion_es" name="descripcion_es"> {{ $slider->descripcion_es }} </textarea>
								</div>
							</div>
							...
							<div class="col s6">							
								<div class="input-field col s12">
									<textarea id="descripcion_pt" name="descripcion_pt"> {{ $slider->descripcion_pt }} </textarea>
								</div>
							</div>
