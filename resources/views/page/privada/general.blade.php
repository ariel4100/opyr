...
<div class="container" style="margin-top: 5%; margin-bottom: 5%">
	<div class="row">
		{{--@if(count($data) == 1 && $data[0] == 'Informacion general')--}}
			...
			{{--@foreach ($descargas as $d)--}}
				{{--@foreach ($d->descargas as $des)--}}
					...
					{{--@dd($data[1] == 'general')--}}
					{{--@if($data[0] == 'general' || isset($data[1]) == 'general')--}}
						{{--<div class="col l6">--}}
		...
		{{--@endif--}}
		{{--@dd($data)--}}
			@if(count($data) == 2 && isset($data[0]) == 'Informacion general' || isset($data[0]) == 'descargas' || isset($data[1]) == 'Informacion general' || isset($data[1]) == 'descargas' )
		...
		{{--@foreach ($descargas as $d)--}}
			{{--@foreach ($d->descargas as $des)--}}
				{{--@php($data = json_decode($des->seccion))--}}
					{{--@dd($data)--}}
				{{--@if(count($data ?? []) == 1 && $data[0] == 'general')--}}
					{{--<div class="col l6">--}}
						{{--<div class="descargas-calidad" style="padding:3% 0% 12%">--}}
